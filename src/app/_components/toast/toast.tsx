...
export default function ToastWithProgressBar(props: any) {
  return (
      <div className="absolute bottom-0 right-0 mx-auto px-4 sm:container">
        <div className="flex justify-end">
          <div className="relative flex w-full max-w-[460px] items-center overflow-hidden rounded-lg bg-white px-5 py-[18px] shadow-1 dark:bg-dark-2 dark:shadow-box-dark">
            ...
            <button className="absolute right-5 top-1/2 -translate-y-1/2 text-dark-5 hover:text-primary dark:text-dark-6" onClick={()=>{props.setError(false)}}>
              <svg
                width={16}
                height={16}
                viewBox="0 0 16 16"
