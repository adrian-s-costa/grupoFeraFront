...
export default function UserInfo(){
  ...
  return (
    <div className="w-full h-screen bg-white p-5">
      ...
      <h1 className="text-3xl font-bold mb-2 mt-[2.5rem]">Estamos quase lá!</h1>
      ...
      <form onSubmit={(e)=>{verifyUserData(e)}} className='mt-5'>
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div>
            <label htmlFor="secName" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sobrenome</label>
            <input type="text" id="secName" onChange={(event)=>{setAdditionalInfo({ ...additionalInfo, secName: event.target.value })}} className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Digite seu sobrenome" required />
          </div>
          <div>
            <label htmlFor="tel" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Telefone</label>
            <input type="tel" id="tel" onChange={(event)=>{setAdditionalInfo({ ...additionalInfo, tel: event.target.value })}} className="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="(99) 9 9999-9999" minLength={9} required />
          </div>
          <div>
            <label htmlFor="date" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data de nascimento</label>
